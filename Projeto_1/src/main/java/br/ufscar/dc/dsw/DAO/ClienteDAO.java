...
public class ClienteDAO extends DAO {
    ...
    public Cliente selectByCpf(String cpf) {
        ...
        String sql = "SELECT * FROM clientes INNER JOIN usuarios ON clientes.cpf = usuarios.cpf WHERE usuarios.cpf = ?";
    ...
    public void update(Cliente cliente) {
        ...
        String query_2 = "UPDATE clientes SET telefone = ?, sexo = ?, data_nascimento = ? WHERE cpf = ?";
        ...
        try {
            ...
            statement_1.setString(1, cliente.getNome());
            statement_1.setString(2, cliente.getEmail());
            statement_1.setString(3, cliente.getSenha());
            statement_1.setString(4, cliente.getCpf());
            statement_1.executeUpdate();
            statement_1.close();

            statement_2.setString(1, cliente.getTelefone());
            statement_2.setString(2, cliente.getSexo());
            statement_2.setDate(3, java.sql.Date.valueOf(cliente.getDataNascimento()));
